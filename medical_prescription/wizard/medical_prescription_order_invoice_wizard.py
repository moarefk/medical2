...
#    Rewrite on 2015 - Dave Lasley - LasLabs - https://laslabs.com
#
...
import logging
from openerp import models, fieldsm
...
class MedicalPrescriptionOrderInvoiceWizard(models.TransientModel):
    _name = "medical.prescription.order.invoice.wizard"
...
# Check if the prescription is invoice exempt, and stop the invoicing process
                ...
                if pres.invoice_status == 'invoiced':
                    ...
                    if len(prescriptions) > 1:
                        ...
                        raise orm.except_orm(
                            _('UserError'),
                            _('Prescription already invoiced'))
...
# Check for empty prescription lines
                ...
                for pres_line in pres.prescription_line:
                    ...
                    if pres_line.medicament.name in prods_data:
                        prods_data[
                            pres_line.medicament.name]['quantity'] += pres_line.quantity
                    else:
